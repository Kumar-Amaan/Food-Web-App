...
const Navbar = () => {
  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-mainbg">
      ...
      <strong className='logo'>FOSO</strong> 
      </NavLink>
        ...
        <ul className="navbar-nav ml-auto">
          ...
          {/* <li className="nav-item">
            <NavLink className="nav-link" to="/service" exact>
              <i className="far fa-address-book"></i>Service
            </NavLink>
          </li> */}
          ...
          {/* <li className="nav-item">
            <NavLink className="nav-link" to="/" exact>
              <i className="fas fa-user-alt"></i>Products
            </NavLink>
          </li> */}
          <li className="nav-item">
          ...
          <li className="nav-item">
            <NavLink className="nav-link" to="/log" exact>
